...
ESVGFILES = $(patsubst %.svg,%.eps,$(SVGFILES))
EFIGFILES = $(patsubst %.fig,%.eps,$(FIGFILES))
ELFIGFILES = $(patsubst %.ltxfig,%.eps,$(LFIGFILES))
EPSTFILES = $(patsubst %.pstricks,%.eps,$(PSTFILES))
EPSFILES = $(wildcard fig/*.eps) $(EGPFILES) $(EOCTFILES) $(EPNGFILES) $(EJPGFILES) $(ESVGFILES) $(EFIGFILES) $(ELFIGFILES) $(EPSTFILES) 
...
clean:  partial-clean
	@cd fig ;\
	for e in .fig .png .jpg .svg .ltxfig _.eps ; do \
